...
def _parse_connection_string(connection_string: str) -> Dict[str, str]:
    ...
    try:
        d: Dict[str, str] = dict(
            arg.split(CS_VAL_SEPARATOR, 1) for arg in cs_args  # type: ignore
        )
    except ValueError:
...
def _validate_keys(d: Dict[str, str]) -> None:
...
class ConnectionString(object):
    ...
    def __init__(self, connection_string: str) -> None:
        ...
        """
        self._dict: Dict[str, str] = _parse_connection_string(connection_string)
        self._strrep: str = connection_string
